...
CREATE TABLE IF NOT EXISTS sigma_rules (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT NOT NULL, rule_yaml TEXT NOT NULL, enabled BOOLEAN DEFAULT 0, source TEXT DEFAULT 'sigma', sigma_uuid TEXT, cloned_from INTEGER, created_by TEXT, created_at DATETIME, updated_by TEXT, updated_at DATETIME, severity_override TEXT);
